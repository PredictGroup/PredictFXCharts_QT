...
LDLIBSOPTIONS=-Wl,-rpath,'ChartDirector/include' -Wl,-rpath,'ChartDirector/lib' ChartDirector/lib/libchartdir.so
...
.build-conf: ${BUILD_SUBPROJECTS} nbproject/qt-${CND_CONF}.mk
	"${MAKE}" -f nbproject/qt-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/PredictFXCharts_OS
